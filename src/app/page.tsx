  ...
  return (
    <main className="relative flex-1 overflow-hidden px-4 py-10 sm:py-16">
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        {/* WhatsApp group */}
        {whatsappGroupUrl ? (
          <section className="animate-fade-up delay-7 mt-8">
            <a
              href={whatsappGroupUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-between gap-4 rounded-2xl border border-emerald-400/30 bg-emerald-500/10 p-4 transition hover:bg-emerald-500/20"
            >
              <div className="flex items-center gap-3">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-300 ring-1 ring-emerald-400/30">
                  <WhatsAppIcon />
                </span>
                <div>
                  ...
                  <p className="text-sm text-emerald-200/70">
                    Get stock updates before the queue opens.
                  </p>
                </div>
              </div>
              <span className="font-mono text-sm text-emerald-300 transition group-hover:translate-x-1">
                Join →
              </span>
            </a>
          </section>
